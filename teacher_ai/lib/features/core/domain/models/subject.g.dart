...
const SubjectSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'year': PropertySchema(
      ...
      name: r'year',
      type: IsarType.string,
      enumMap: _SubjectyearEnumValueMap,
    )
  },
  ...
  idName: r'id',
  indexes: {
    r'name_userId': IndexSchema(
      id: -245503699014983319,
      name: r'name_userId',
      unique: true,
      replace: false,
      properties: [
...
int _subjectEstimateSize(
  ...
  bytesCount += 3 + object.year.name.length * 3;
  return bytesCount;
}
...
void _subjectSerialize(
  ...
  writer.writeString(offsets[7], object.year.name);
}
...
Subject _subjectDeserialize(
  ...
  final object = Subject(
    ...
    studentIds: reader.readLongList(offsets[4]) ?? const [],
    userId: reader.readString(offsets[6]),
    year: _SubjectyearValueEnumMap[reader.readStringOrNull(offsets[7])] ??
        ClassYear.firstYear,
  );
...
P _subjectDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 6:
      return (reader.readString(offset)) as P;
    case 7:
      return (_SubjectyearValueEnumMap[reader.readStringOrNull(offset)] ??
          ClassYear.firstYear) as P;
    default:
      throw IsarError('Unknown property with id $propertyId');
  }
}

const _SubjectyearEnumValueMap = {
  r'firstYear': r'firstYear',
  r'secondYear': r'secondYear',
  r'thirdYear': r'thirdYear',
  r'transitionYear': r'transitionYear',
  r'fifthYear': r'fifthYear',
  r'sixthYear': r'sixthYear',
};
const _SubjectyearValueEnumMap = {
  r'firstYear': ClassYear.firstYear,
  r'secondYear': ClassYear.secondYear,
  r'thirdYear': ClassYear.thirdYear,
  r'transitionYear': ClassYear.transitionYear,
  r'fifthYear': ClassYear.fifthYear,
  r'sixthYear': ClassYear.sixthYear,
};
...
extension SubjectByIndex on IsarCollection<Subject> {
  Future<Subject?> getByNameUserId(String name, String userId) {
    return getByIndex(r'name_userId', [name, userId]);
  }

  Subject? getByNameUserIdSync(String name, String userId) {
    return getByIndexSync(r'name_userId', [name, userId]);
  }

  Future<bool> deleteByNameUserId(String name, String userId) {
    return deleteByIndex(r'name_userId', [name, userId]);
  }

  bool deleteByNameUserIdSync(String name, String userId) {
    return deleteByIndexSync(r'name_userId', [name, userId]);
  }

  Future<List<Subject?>> getAllByNameUserId(
      List<String> nameValues, List<String> userIdValues) {
    final len = nameValues.length;
    assert(userIdValues.length == len,
        'All index values must have the same length');
    final values = <List<dynamic>>[];
    for (var i = 0; i < len; i++) {
      values.add([nameValues[i], userIdValues[i]]);
    }

    return getAllByIndex(r'name_userId', values);
  }

  List<Subject?> getAllByNameUserIdSync(
      List<String> nameValues, List<String> userIdValues) {
    final len = nameValues.length;
    assert(userIdValues.length == len,
        'All index values must have the same length');
    ...
    return getAllByIndexSync(r'name_userId', values);
  }

  Future<int> deleteAllByNameUserId(
      List<String> nameValues, List<String> userIdValues) {
    final len = nameValues.length;
    assert(userIdValues.length == len,
        'All index values must have the same length');
    ...
    return deleteAllByIndex(r'name_userId', values);
  }

  int deleteAllByNameUserIdSync(
      List<String> nameValues, List<String> userIdValues) {
    final len = nameValues.length;
    assert(userIdValues.length == len,
        'All index values must have the same length');
    ...
    return deleteAllByIndexSync(r'name_userId', values);
  }

  Future<Id> putByNameUserId(Subject object) {
    return putByIndex(r'name_userId', object);
  }

  Id putByNameUserIdSync(Subject object, {bool saveLinks = true}) {
    return putByIndexSync(r'name_userId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByNameUserId(List<Subject> objects) {
    return putAllByIndex(r'name_userId', objects);
  }

  List<Id> putAllByNameUserIdSync(List<Subject> objects,
      {bool saveLinks = true}) {
    return putAllByIndexSync(r'name_userId', objects, saveLinks: saveLinks);
  }
}
...
extension SubjectQueryWhere on QueryBuilder<Subject, Subject, QWhereClause> {
  ...
  QueryBuilder<Subject, Subject, QAfterWhereClause> nameEqualToAnyUserId(
      String name) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name_userId',
        value: [name],
      ));
    });
  }

  QueryBuilder<Subject, Subject, QAfterWhereClause> nameNotEqualToAnyUserId(
      String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Subject, Subject, QAfterWhereClause> nameUserIdEqualTo(
  ...
  QueryBuilder<Subject, Subject, QAfterWhereClause> nameEqualToUserIdNotEqualTo(
      String name, String userId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Subject, Subject, QAfterWhereClause> userIdEqualTo(
      String userId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'userId',
  ...
  QueryBuilder<Subject, Subject, QAfterWhereClause> userIdNotEqualTo(
      String userId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension SubjectQueryFilter
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition>
      studentIdsElementEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> studentIdsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> studentIdsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'studentIds',
        0,
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> studentIdsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'studentIds',
        0,
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> studentIdsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> userIdEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> userIdGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> userIdLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> userIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> userIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> userIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> userIdContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> userIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> userIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'userId',
        value: '',
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> userIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'userId',
        value: '',
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> yearEqualTo(
    ClassYear value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> yearGreaterThan(
    ClassYear value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> yearLessThan(
    ClassYear value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> yearBetween(
    ClassYear lower,
    ClassYear upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> yearStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> yearEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> yearContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> yearMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> yearIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'year',
        value: '',
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> yearIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'year',
        value: '',
...
extension SubjectQuerySortBy on QueryBuilder<Subject, Subject, QSortBy> {
  ...
  QueryBuilder<Subject, Subject, QAfterSortBy> sortByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<Subject, Subject, QAfterSortBy> sortByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.desc);
    });
  }

  QueryBuilder<Subject, Subject, QAfterSortBy> sortByYear() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'year', Sort.asc);
    });
  }

  QueryBuilder<Subject, Subject, QAfterSortBy> sortByYearDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SubjectQuerySortThenBy
  ...
  QueryBuilder<Subject, Subject, QAfterSortBy> thenByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<Subject, Subject, QAfterSortBy> thenByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.desc);
    });
  }

  QueryBuilder<Subject, Subject, QAfterSortBy> thenByYear() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'year', Sort.asc);
    });
  }

  QueryBuilder<Subject, Subject, QAfterSortBy> thenByYearDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'year', Sort.desc);
    });
  }
...
extension SubjectQueryWhereDistinct
  ...
  QueryBuilder<Subject, Subject, QDistinct> distinctByStudentIds() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QDistinct> distinctByUserId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QDistinct> distinctByYear(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SubjectQueryProperty
  ...
  QueryBuilder<Subject, List<int>, QQueryOperations> studentIdsProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, String, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'userId');
    });
  }

  QueryBuilder<Subject, ClassYear, QQueryOperations> yearProperty() {
    return QueryBuilder.apply(this, (query) {
